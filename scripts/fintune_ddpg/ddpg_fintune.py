...
if __name__ == '__main__':
    ...
    outdir = current_folder_path + '/training_results/ddpg_finetune/'
    torch.manual_seed(0)
    ...
    # agent.actor.load_state_dict(torch.load('/home/sezer/catkin_ws/src/turtlebot3_ddpg_collision_avoidance/training_results/offline_ddpg_training/saved_models/22/DDPG_turtlebot3_continuous_59999_actor.pth'))
    # agent.critic.load_state_dict(torch.load('/home/sezer/catkin_ws/src/turtlebot3_ddpg_collision_avoidance/training_results/offline_ddpg_training/saved_models/22/DDPG_turtlebot3_continuous_59999_critic.pth'))
    # agent.actor_target.load_state_dict(torch.load('/home/sezer/catkin_ws/src/turtlebot3_ddpg_collision_avoidance/training_results/offline_ddpg_training/saved_models/22/DDPG_turtlebot3_continuous_59999_actor.pth'))
    # agent.critic_target.load_state_dict(torch.load('/home/sezer/catkin_ws/src/turtlebot3_ddpg_collision_avoidance/training_results/offline_ddpg_training/saved_models/22/DDPG_turtlebot3_continuous_59999_critic.pth'))
    num_episodes = 100000
